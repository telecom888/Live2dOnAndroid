    ...
    companion object {
        fun parse(value: String): PairingPayload {
            ...
            return PairingPayload(
                ...
                name = json.optString("name", "BangDreamPet Desktop"),
                hosts = hosts,
...
object CompanionSettings {
    private const val PREFS = "bangdream_pet_companion"
    ...
    private fun credentialAlias(instanceId: String): String = "bangdream_pet_companion_${instanceId.replace("-", "").take(32)}"
